"""Native K3 sparse route generation (score -> partition-local route selection).

The route kernels produce the certified routes the sparse-state ops consume; the
route provider serves the SparseRouteSelectionSpec descriptor.
"""

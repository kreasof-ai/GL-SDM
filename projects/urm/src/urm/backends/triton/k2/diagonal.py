"""Native diagonal-SSM recurrence (Mamba-2 class): the diagonal state-width schedule.

Benchmark-facing physical schedule (not a plan-wired provider): the chunked/parallel
diagonal scan used by the alignment harness. The plan-wired K2 providers live in
``matrix_scan.py``.
"""

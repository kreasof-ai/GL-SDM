...
`atma_gated_delta_decode_core`, `attnres_depth_core`, `bdh_attention_core`, `foveal_sparse_polar_attention_core`, `fox`, `fwpkm_memory_read_core`, `log_linear_attention_core`, `moba_selected_attention_core`, `path_attention_core`, `pgdn_core`, `pkda_core`, `polar_attention_core`.

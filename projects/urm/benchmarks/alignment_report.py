...
def _k1_decode_kl(torch) -> list[dict]:
    ...
    from urm.backends.providers.k1.triton import execute_online_softmax_decode
...
def _k2_gated_delta_decode_kl(torch) -> list[dict]:
    ...
    from urm.backends.providers.k2.triton_matrix import (
...
def _k2_diagonal_decode_kl(torch) -> list[dict]:
    ...
    from urm.backends.providers.k2.triton_diagonal import (

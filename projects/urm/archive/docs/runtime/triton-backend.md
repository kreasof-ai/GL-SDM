...
[the optimization report](../../archive/docs/triton-optimization-report.md) for findings):
...
[the optimization report](../../archive/docs/triton-optimization-report.md). Any future kernel

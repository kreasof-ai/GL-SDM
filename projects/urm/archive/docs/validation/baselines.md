...
| Linear attention | Explicit recurrent/chunk reference | PyTorch eager recurrence | Flash Linear Attention (pinned 0.5.2 gated delta-rule comparator landed; see docs/adapters/fla-gated-delta-rule.md) | Recurrent lowering | Validated gated-delta-rule comparator; native lowering deferred |
...
claim.
See [the frozen contract](../adapters/sparse-delta-memory.md). No upstream kernel source is

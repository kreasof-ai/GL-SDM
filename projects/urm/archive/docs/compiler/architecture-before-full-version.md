...
[CODA retrospective](../../archive/docs/coda-retrospective.md)); optimized kernels are its
...
- Performance regret versus the best pinned upstream implementation per family
  (paired-overhead methodology from docs/validation/benchmarking.md).
...
[Triton backend preparation](../runtime/triton-backend.md).
...
nanoGPT implementation; see `docs/validation/pretraining-step.md`.

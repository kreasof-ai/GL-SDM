"""Historical Triton dual-form prototype; NOT a certified compiler backend.

Known defects include omitted cross-block dependencies and incomplete gradients.
Claims below describe the original experiment, not current acceptance. See
docs/kernels/sparse-delta.md for the corrected contract.
...
class TritonSparseDeltaFunction(torch.autograd.Function):
    """Complete autograd function wrapping the Triton sparse routed delta kernels."""
...
def triton_sparse_delta(
    ...
    *,
    ...
    """Execute sparse routed delta sequence mixer using pure Triton kernels."""
    return TritonSparseDeltaFunction.apply(
        memory,
        read_indices,
        read_weights,
        write_indices,
...
__all__ = [
    "_sparse_delta_fwd_kernel",
    "_sparse_delta_bwd_kernel",
    "TritonSparseDeltaFunction",
    "triton_sparse_delta",
]
